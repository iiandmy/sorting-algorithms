...
public interface RepoBasedComparator<T> extends Comparator<T> {
     ...
     * - Positive integer in case, when o1 - known value in repo, o2 - unknown value in repo;<br>
     * - Zero in case, when o1 - unknown value in repo, o2 - unknown value in repo;<br>
     * - Negative integer or less in case, when o1 - unknown value in repo, o2 - known value in repo;
     * @return positive integer - when index of o1's value is less than index of o2's value;<br>
     *         zero - when index of o1's value equals index of o2's value;<br>
     *         negative integer - when index of o1's value is greater than index of o2's value;
     */
